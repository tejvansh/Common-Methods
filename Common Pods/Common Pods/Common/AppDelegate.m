...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	//SDWebImage download preference
	...
	[[UINavigationBar appearance] setBarTintColor:RGB(0, 0, 50)];
	[[UINavigationBar appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor whiteColor], NSForegroundColorAttributeName, [UIFont fontWithName:kFontRegular size:17], NSFontAttributeName, nil]];
